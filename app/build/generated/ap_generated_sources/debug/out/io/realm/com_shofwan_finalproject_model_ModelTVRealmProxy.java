...
public class com_shofwan_finalproject_model_ModelTVRealmProxy extends com.shofwan.finalproject.model.ModelTV
    implements RealmObjectProxy, com_shofwan_finalproject_model_ModelTVRealmProxyInterface {
    ...
    private ProxyState<com.shofwan.finalproject.model.ModelTV> proxyState;

    com_shofwan_finalproject_model_ModelTVRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.shofwan.finalproject.model.ModelTV>(this);
    ...
    @SuppressWarnings("cast")
    public static com.shofwan.finalproject.model.ModelTV createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.shofwan.finalproject.model.ModelTV obj = realm.createObjectInternal(com.shofwan.finalproject.model.ModelTV.class, true, excludeFields);

        final com_shofwan_finalproject_model_ModelTVRealmProxyInterface objProxy = (com_shofwan_finalproject_model_ModelTVRealmProxyInterface) obj;
        if (json.has("Id")) {
            if (json.isNull("Id")) {
    ...
    public static com.shofwan.finalproject.model.ModelTV createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.shofwan.finalproject.model.ModelTV obj = new com.shofwan.finalproject.model.ModelTV();
        final com_shofwan_finalproject_model_ModelTVRealmProxyInterface objProxy = (com_shofwan_finalproject_model_ModelTVRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.shofwan.finalproject.model.ModelTV copyOrUpdate(Realm realm, com.shofwan.finalproject.model.ModelTV object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.shofwan.finalproject.model.ModelTV) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.shofwan.finalproject.model.ModelTV copy(Realm realm, com.shofwan.finalproject.model.ModelTV newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.shofwan.finalproject.model.ModelTV realmObject = realm.createObjectInternal(com.shofwan.finalproject.model.ModelTV.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_shofwan_finalproject_model_ModelTVRealmProxyInterface realmObjectSource = (com_shofwan_finalproject_model_ModelTVRealmProxyInterface) newObject;
        com_shofwan_finalproject_model_ModelTVRealmProxyInterface realmObjectCopy = (com_shofwan_finalproject_model_ModelTVRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.shofwan.finalproject.model.ModelTV object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.shofwan.finalproject.model.ModelTV.class);
        long tableNativePtr = table.getNativePtr();
        ModelTVColumnInfo columnInfo = (ModelTVColumnInfo) realm.getSchema().getColumnInfo(com.shofwan.finalproject.model.ModelTV.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        Table.nativeSetLong(tableNativePtr, columnInfo.IdIndex, rowIndex, ((com_shofwan_finalproject_model_ModelTVRealmProxyInterface) object).realmGet$Id(), false);
        String realmGet$Name = ((com_shofwan_finalproject_model_ModelTVRealmProxyInterface) object).realmGet$Name();
        if (realmGet$Name != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.NameIndex, rowIndex, realmGet$Name, false);
        }
        Table.nativeSetDouble(tableNativePtr, columnInfo.VoteAverageIndex, rowIndex, ((com_shofwan_finalproject_model_ModelTVRealmProxyInterface) object).realmGet$VoteAverage(), false);
        String realmGet$Overview = ((com_shofwan_finalproject_model_ModelTVRealmProxyInterface) object).realmGet$Overview();
        if (realmGet$Overview != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.OverviewIndex, rowIndex, realmGet$Overview, false);
        }
        String realmGet$ReleaseDate = ((com_shofwan_finalproject_model_ModelTVRealmProxyInterface) object).realmGet$ReleaseDate();
        ...
        String realmGet$PosterPath = ((com_shofwan_finalproject_model_ModelTVRealmProxyInterface) object).realmGet$PosterPath();
        ...
        String realmGet$BackdropPath = ((com_shofwan_finalproject_model_ModelTVRealmProxyInterface) object).realmGet$BackdropPath();
        ...
        String realmGet$Popularity = ((com_shofwan_finalproject_model_ModelTVRealmProxyInterface) object).realmGet$Popularity();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        ModelTVColumnInfo columnInfo = (ModelTVColumnInfo) realm.getSchema().getColumnInfo(com.shofwan.finalproject.model.ModelTV.class);
        com.shofwan.finalproject.model.ModelTV object = null;
        while (objects.hasNext()) {
            object = (com.shofwan.finalproject.model.ModelTV) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.shofwan.finalproject.model.ModelTV object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.shofwan.finalproject.model.ModelTV.class);
    ...
    public static com.shofwan.finalproject.model.ModelTV createDetachedCopy(com.shofwan.finalproject.model.ModelTV realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.shofwan.finalproject.model.ModelTV unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.shofwan.finalproject.model.ModelTV();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.shofwan.finalproject.model.ModelTV) cachedObject.object;
            }
            unmanagedObject = (com.shofwan.finalproject.model.ModelTV) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_shofwan_finalproject_model_ModelTVRealmProxyInterface unmanagedCopy = (com_shofwan_finalproject_model_ModelTVRealmProxyInterface) unmanagedObject;
        com_shofwan_finalproject_model_ModelTVRealmProxyInterface realmSource = (com_shofwan_finalproject_model_ModelTVRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_shofwan_finalproject_model_ModelTVRealmProxy aModelTV = (com_shofwan_finalproject_model_ModelTVRealmProxy)o;
